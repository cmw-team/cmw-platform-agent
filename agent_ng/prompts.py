...
def build_skill_prompt_section(skills_dir: Path | str | None) -> str:
    ...
    return (
        ...
        "when you judge the skill is needed. When calling it, call "
        "`load_skill` by itself and wait for its result before choosing or "
        "calling any other tool. The skill body will be loaded "
