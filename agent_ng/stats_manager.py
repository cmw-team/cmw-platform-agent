...
class StatsManager:
    ...
    def __init__(self):
        ...
        self.llm_tracking: Dict[str, Dict[str, int]] = defaultdict(
    ...
    def track_conversation(
        ...
        Args:
            ...
            session_id: Session ID for isolation
            full_model_name: Full model name (provider/model) for tracking
        """
        ...
        conversation_data = {
            ...
            or llm_used,  # Use full_model_name if provided, fallback to llm_used
        ...
        if self.conversation_stats.total_questions > 0:
            self.conversation_stats.avg_tool_calls_per_question = (
                self.conversation_stats.total_tool_calls
                / self.conversation_stats.total_questions
            )
            self.conversation_stats.avg_duration_per_question = (
                self.conversation_stats.total_duration
                / self.conversation_stats.total_questions
            )
    ...
    def _update_error_rate(self):
        ...
        total = (
            self.system_stats.successful_requests + self.system_stats.failed_requests
        )
        if total > 0:
    ...
    def get_conversation_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_questions_per_conversation": (
                ...
                if self.conversation_histories
                else 0
            ),
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "most_common_error": self.error_counts.most_common(1)[0]
            if total_errors > 0
            else None,
        }
